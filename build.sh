...
git_clone() {
    # filecash/v0.9.0
    source $CLONE_AND_CHECKOUT "https://github.com/filecash/lotus.git" lotus "a1176825cf7ecdbaf827dddcc522207d61038034"
    ...
    source $CLONE_AND_CHECKOUT "https://github.com/filecash/specs-actors.git" specs-actors-v0.9.12 "268628fc830236bc0ef020ce15cea7722cd40d60"
