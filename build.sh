...
git_clone() {
    # filecash/v0.9.0
    source $CLONE_AND_CHECKOUT "https://github.com/filecash/lotus.git" lotus "c81c79b45317399659dfffe3a3b67a9aa8fbd7d7"
    ...
    source $CLONE_AND_CHECKOUT "https://github.com/filecash/go-jsonrpc.git" go-paramfetch "bf08846f47ccf43bb656f8c44054f2e5fbf1c122"
